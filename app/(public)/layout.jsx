...
const PublicLayout = ({children}) => {
  ...
  return (
    <div>
        <div className='flex justify-between items-center max-sm:sticky top-0 left-0 z-10 bg-gradient-to-r from-red-50 via-red-200 to-red-900 border-2 border-red-800 '>
